...
export const productsData: Record<'multivitamin' | 'fishoil', ProductInfo> = {
  multivitamin: {
    title: 'Multivitamin',
    ...
    images: ['/assets/multivitamin.png', '/assets/multivitaminback.png', '/assets/multivitamin-label.png'],
  ...
  fishoil: {
    ...
    images: ['/assets/fishoil.png', '/assets/fishoilback.png', '/assets/fishoil-label.png'],
